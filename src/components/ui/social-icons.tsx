...
// lucide-react dropped its brand glyphs, so we ship the two we actually use as
// inline SVGs. Both accept a `size` prop to mirror the lucide icon API.

export function WhatsAppIcon({ size = 20, ...rest }: BrandIconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FacebookIcon({ size = 20, ...rest }: BrandIconProps) {
  return (
    <svg
      width={size}
      height={size}
